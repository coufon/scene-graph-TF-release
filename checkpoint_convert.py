...
RNN_NAME_REPLACEMENTS = collections.OrderedDict([
    ...
    ('GRUCell/Gates/Linear/Matrix', 'gru_cell/gates/kernel'),
    ('GRUCell/Gates/Linear/Bias', 'gru_cell/gates/bias'),
    ('GRUCell/Candidate/Linear/Matrix', 'gru_cell/candidate/kernel'),
    ('GRUCell/Candidate/Linear/Bias', 'gru_cell/candidate/bias'),    
    # BasicLSTMCell
